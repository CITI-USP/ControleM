...
Um módulo Bluetooth serial provê a comunicação remota sem fio, através de um protocolo simples e robusto são recebidos os dados necessário para controlar as saídas DAC.O módulo Bluettoh teve a velocidade ajustada para 115200 bps (comando: AT+BAUD8 mais informações: [AT command mode of HC-05 and HC-06 Bluetooth module] ( http://www.instructables.com/id/AT-command-mode-of-HC-05-Bluetooth-module/?ALLSTEPS)
